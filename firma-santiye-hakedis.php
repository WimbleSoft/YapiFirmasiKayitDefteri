...
<nav id="secondary">
      <ul>
        ...
        <li class="current"><a href="firma-santiye-hakedis.php?id=<?=$scek['id'];?>&firmaid=<?=$scek['firmaid'];?>">Hakediş</a></li>
...
<br><br>
<div>
  <form action="firma-santiye-hakedis-kontrol.php" method="post" enctype="multipart/form-data">
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>Şantiye Adı</td>
    <td colspan="2"><input readonly  name="konu3" type="text" id="konu3" value="<?=$scek['santiyeadi'];?>" /></td>
  </tr>
  <tr>
    <td>İLGİLİ :</td>
    <td colspan="3"><input readonly  name="ilgili" type="text" id="ilgili"size="49" value="<?=$scek['ad'];?> <?=$scek['soyad'];?>" /></td>
    <td>&nbsp;</td>
    <td><input type="submit" name="hakedis" id="hakedis" value="Hakedişi Kaydet" class="button primary submit"/>
      <input type="button" name="hakedis2" id="hakedis2" value="Hakedişi Yazdır" onClick="window.open('firma-santiye-hakedis-yazdir.php?id=<?=$scek['id'];?>&firmaid=<?=$scek['firmaid'];?>','_blank')" class="button primary submit"/></td>
    
    <td colspan="2"><input type="submit" name="fatura" id="fatura" value="Faturaya Dönüştür" class="button primary submit"/></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td><span class="fsdfgsfdsf">
      <input readonly hidden="hidden" name="kdv" type="text" id="kdv" onKeyUp="hesaplag(),cevir()" value=18 size="8" />
