...
$aciklamax1=$connection->quote($_POST['aciklamax1']);
$aciklamax2=$connection->quote($_POST['aciklamax2']);
$aciklamax3=$connection->quote($_POST['aciklamax3']);
$aciklamax4=$connection->quote($_POST['aciklamax4']);
$aciklamax5=$connection->quote($_POST['aciklamax5']);
$aciklamax6=$connection->quote($_POST['aciklamax6']);
$aciklamax7=$connection->quote($_POST['aciklamax7']);
$aciklamax8=$connection->quote($_POST['aciklamax8']);
$aciklamax9=$connection->quote($_POST['aciklamax9']);
$aciklamax10=$connection->quote($_POST['aciklamax10']);
$aciklamax11=$connection->quote($_POST['aciklamax11']);
$aciklamax12=$connection->quote($_POST['aciklamax12']);
$aciklamax13=$connection->quote($_POST['aciklamax13']);
$aciklamax14=$connection->quote($_POST['aciklamax14']);
$aciklamax15=$connection->quote($_POST['aciklamax15']);
$aciklamax16=$connection->quote($_POST['aciklamax16']);
$aciklamax17=$connection->quote($_POST['aciklamax17']);
$aciklamax18=$connection->quote($_POST['aciklamax18']);
$aciklamax19=$connection->quote($_POST['aciklamax19']);
$aciklamax20=$connection->quote($_POST['aciklamax20']);
...
if(isset($ayarguncelle)){
	$durum="<h2>İşlem Başarılı Hakediş Kaydedildi</h2>";
	echo "<meta http-equiv=\"refresh\" content=\"0;url=firma-santiye-hakedis.php?id=$santiyeid&firmaid=$firmaid\">";
	echo "$durum";
}
if(isset($ayarguncelle2)){
	$durum="<h2>İşlem Başarılı. Faturya Dönüştürüldü</h2>";
	echo "<meta http-equiv=\"refresh\" content=\"0;url=firma-santiye-fatura.php?id=$santiyeid&firmaid=$firmaid\">";
	echo "$durum";
}
?>
<!-- GİRİŞ KONTROL -->          
