...
$ayarguncelle=$connection->query("UPDATE insaat_kasa set aciklama=".$aciklama.",tarih='$tarih',gelir_nakit='$gelir_nakit',gelir_cek='$gelir_cek',gider_nakit='$gider_nakit',gider_cek='$gider_cek' where id='$id'") or die ("Bir Hata Oluştu");
