...
<?php include("kontrol/veritabani.php") ?>
            ...
            <nav id="secondary">
              <ul>
                <li ><a href="gunluk.php">Günlük</a></li>
                <li class="current"><a href="gunluk-ekle.php">Günlük Ekle</a></li>
               </ul>
            </nav>
            ...
            <section id="content">
<h2>Günlük ekleniyor.</h2>
<form class="wymupdate" action="gunluk-ekle-kontrol.php" enctype="multipart/form-data" method="post" > 
