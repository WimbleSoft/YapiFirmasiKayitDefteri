...
?>
<form action="firma-santiye-montajci-duzenle-kontrol.php" class="wymupdate" enctype="multipart/form-data" method="post" > 
	   <div class="column left">
		<section>
		  <label for="label">
			Montaj Ekibi
		  ...
		  <div>
			<input name="montajekibi" required="required" id="montajekibi" type="text" value="<?=$mcek['montajekibi'];?>"/>
		  </div>
		</section>
		 <section>
		  <label for="label">
        ...
        <input name="gonder" class="button" type="submit" size="50" style="width:500px; height:150px; font-size:30px"  value="MONTAJCIYI GÜNCELLE" />
	  </div>
	<div class="column right">
		<table width="200" border="1">
		  ...
		  <tr>
			...
			<td><label for="doseme_fiyati"></label>
			  <input name="doseme_metraji"type="text" id="doseme_metraji" onkeyup="hesapla()"  onclick="cleard(this.id)" value="<?=$mcek['doseme_metraji'];?>" size="12" /></td>
			<td><input name="doseme_fiyati"onkeyup="hesapla()"  onclick="cleard(this.id)" type="text" id="doseme_fiyati"value="<?=$mcek['doseme_fiyati'];?>" size="12" /></td>
			<td><input name="doseme" type="text" id="doseme" size="12" value="<?=$mcek['doseme_metraji']*$mcek['doseme_fiyati'];?>"/></td>
		  </tr>
		  <tr>
			<td class="fgfgfg">SÜPÜRGELİK</td>
			<td><input name="supurgelik_metraji"onkeyup="hesapla()"  onclick="cleard(this.id)" type="text" id="supurgelik_metraji"value="<?=$mcek['supurgelik_metraji'];?>" size="12" /></td>
			<td><input name="supurgelik_fiyati"onkeyup="hesapla()"  onclick="cleard(this.id)" type="text" id="supurgelik_fiyati"value="<?=$mcek['supurgelik_fiyati'];?>" size="12" /></td>
			<td><input name="supurgelik" type="text" id="supurgelik" size="12" value="<?=$mcek['supurgelik_fiyati']*$mcek['supurgelik_metraji'];?>"/></td>
		  </tr>
		  <tr>
			<td class="fgfgfg">SÖVE</td>
			<td><input name="sove_metraji"onkeyup="hesapla()"  onclick="cleard(this.id)" type="text" id="sove_metraji"value="<?=$mcek['sove_metraji'];?>"size="12" /></td>
			<td><input name="sove_fiyati"onkeyup="hesapla()"  onclick="cleard(this.id)" type="text" id="sove_fiyati"value="<?=$mcek['sove_fiyati'];?>"size="12" /></td>
			<td><input name="sove" type="text" id="sove" size="12" value="<?=$mcek['sove_fiyati']*$mcek['sove_metraji'];?>"/></td>
		  </tr>
		  <tr>
			<td class="fgfgfg">DENİZLİK</td>
			<td><input name="denizlik_metraji" onkeyup="hesapla()"  onclick="cleard(this.id)"type="text" id="denizlik_metraji"value="<?=$mcek['denizlik_metraji'];?>" size="12" /></td>
			<td><input name="denizlik_fiyati" onkeyup="hesapla()"  onclick="cleard(this.id)"type="text" id="denizlik_fiyati"value="<?=$mcek['denizlik_fiyati'];?>" size="12" /></td>
			<td><input name="denizlik" type="text" id="denizlik" size="12" value="<?=$mcek['denizlik_fiyati']*$mcek['denizlik_metraji'];?>" /></td>
		  </tr>
		  <tr>
			<td class="fgfgfg">BASAMAK</td>
			<td><input name="basamak_metraji" onkeyup="hesapla()"  onclick="cleard(this.id)"type="text" id="basamak_metraji"value="<?=$mcek['basamak_metraji'];?>" size="12" /></td>
			<td><input name="basamak_fiyati" onkeyup="hesapla()"  onclick="cleard(this.id)" type="text" id="basamak_fiyati"value="<?=$mcek['basamak_fiyati'];?>" size="12" /></td>
			<td><input name="basamak" type="text" id="basamak" size="12" value="<?=$mcek['basamak_fiyati']*$mcek['basamak_metraji'];?>" /></td>
		  </tr>
		  <tr>
			<td colspan="3" class="dssdsd" style="font-weight: bold">HAKEDİŞİ TOPLAMI</td>
			<td style="font-weight: bold"><input name="hakedis_toplami" type="text" id="hakedis_toplami"value="<?=$mcek['hakedis_toplami'];?>" size="12" /></td>
		  </tr>
		  <?php	} ?>
		</table>
